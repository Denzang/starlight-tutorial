...
- [MySQL](https://dev.mysql.com/downloads/installer/) - MySQL Installation Link
...
:::note
When the order of the input is in the same order as the field/column order, the columns in the code are omitted. Enter `SELECT * FROM tableName;` to verify if the data was entered.
:::
