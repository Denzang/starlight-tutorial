...
draft: false
description: This post outlines JavaScript norms and rules for clear, readable code.
---
...
Do not use three different verbs for the same kind of task when assigning names to variables.
...
- **Use searchable and easily understandable names**
...
1. [AirBnB Style Guide for JavaScript Styling](https://github.com/airbnb/javascript)
2. [TypeScript Styling Guide at Google](https://google.github.io/styleguide/tsguide.html)
3. [ESLint](https://eslint.org/docs/latest/use/getting-started) - [Uses](https://hackernoon.com/how-linting-and-eslint-improve-code-quality-fa83d2469efe)
4. [Beautiful JavaScript: Easily Create Chainable (Cascading) Methods for Expressiveness](https://web.archive.org/web/20190211152543/https://javascriptissexy.com/beautiful-javascript-easily-create-chainable-cascading-methods-for-expressiveness/)
