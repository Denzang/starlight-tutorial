...
- [Official Guide For MySQL Connector Python](https://dev.mysql.com/doc/connector-python/en/)
- Use the command `pip install mysql-connector-python` to install MySQL Python & import the module as `import mysql.connector`
