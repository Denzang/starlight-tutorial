...
[Interactive CSS CheatSheet To Try Out CSS Styling](https://htmlcheatsheet.com/css/) |
...
**Flex Shorthand** - The **flex** declaration is actually a shorthand for 3 properties that you can set on a flex item.  
...
More on flex [can be hadhere](https://developer.mozilla.org/en-US/docs/Web/CSS/flex)
